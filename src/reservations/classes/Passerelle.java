 ...
 * utilise le modèle Jaxp pour parcourir le document XML Ce modèle fait partie
...
public class Passerelle {
	...
	private static String _adresseHebergeur = "http://localhost/ws-php-Killian/m.m2l/services/";
	...
	public static String connecter(String nomUtilisateur, String mdpUtilisateur) {
		String reponse = "";
		try { // préparation des paramètres à poster vers le service web
	...
	// Méthode de classe pour récupérer les réservations d'un utilisateur
	// (service ConsulterReservations.php)
	public static String confirmerReservation(Utilisateur unUtilisateur, Reservation uneReservation) {
		String reponse = "";
		try { // préparation des paramètres à poster vers le service web
			ArrayList<NameValuePair> parametresPostes = new ArrayList<NameValuePair>();
			parametresPostes.add(new BasicNameValuePair("nom", unUtilisateur.getName()));
			parametresPostes.add(new BasicNameValuePair("mdp", unUtilisateur.getPassword()));
			parametresPostes.add(new BasicNameValuePair("Reservation", String.valueOf(uneReservation.getId())));
			// création d'un nouveau document XML à partir de l'URL du service
			// web et des paramètres
